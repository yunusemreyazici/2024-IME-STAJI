...
namespace Maps_Project.Texts {
    ...
    export declare namespace Db {
        ...
        namespace Trip {
            ...
            namespace BusinessTripDetail {
                export const BusinessTripId: string;
                export const BusinessTripTitle: string;
                export const Coordinate: string;
                export const Id: string;
            }
        }
    }
    ...
    Maps_Project['Texts'] = proxyTexts(Texts, '', {
        Db: {
            Administration: {
                Language: {},
                Role: {},
...
export const Texts = Maps_Project.Texts;